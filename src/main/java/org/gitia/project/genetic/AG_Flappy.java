 ...
 */
public class AG_Flappy extends AG1 {
     ...
     */
    public AG_Flappy(int epoch, int populationSize, int dnaSize, double offspring, double elite, double mutation, int tournament_size, double min, double max) {
        this.genMax = epoch;
    ...
    public void run() {
        ...
        MultiNonUniformMutation.mutacion(listNoCruzada, numMutacion, min, max, genActual, genMax);
